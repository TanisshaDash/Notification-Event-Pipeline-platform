...
import { useDeliveryLogs } from "../hooks/useDeliveryLogs.ts";
...
export function DeliveryTable() {
  ...
  const { logs, total, loading, page, setPage, refetch } =
    useDeliveryLogs(filter === "ALL" ? undefined : filter);
    ...
    <div style={{ animation: "fadeIn .5s ease both" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 12 }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <span style={{ fontFamily: "var(--mono)", fontSize: 11, color: "var(--text3)", padding: "4px 8px" }}>
            pg {page}
          </span>
